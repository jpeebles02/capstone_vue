...
\* -------------------- */
    ...
    $(".rating-stars__new > li").on("click", function() {
        ...
        $(".rating-stars__new > li > i")
            .removeClass("fa-star-o fa-star")
            .addClass("fa-star-o");
...
\* -------------------- */
    ...
    $(".features__item").hover(
        function() {
            $(this)
                .find("i.fa")
                .removeClass("features-icon_leave")
                .addClass("features-icon_enter");
        },
        function() {
            $(this)
                .find("i.fa")
                .removeClass("features-icon_enter")
                .addClass("features-icon_leave");
        }
    );
